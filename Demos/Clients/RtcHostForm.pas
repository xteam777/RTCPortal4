...
uses
  Windows, Messages, SysUtils, rtcSystem,
...
{$ENDIF}
  ...
  rtcPortalHttpCli, rtcPortalMod, rtcPortalCli, jpeg, Buttons, rtcpCustomComm;
...
procedure TMainForm.FormCreate(Sender: TObject);
  ...
  PFileTrans.FileInboxPath:= ExtractFilePath(ParamStr(0))+'\INBOX';
...
procedure TMainForm.LoadSetup;
  ...
  CfgFileName:= ChangeFileExt(ParamStr(0),'.inf');
