...
type
  ...
  published
    ...
    { Large files are split in smaller chunks. Maximum allowed chunk size is MaxSendChunkSize bytes.
      ...
      Using larger chunks may improve performance, but it can also reduce the risk of a file
  ...
  begin
    ...
    begin
      ...
      if Data.asLargeInt['at'] = 0 then
        ...
        Write_File(tofile, s, rtc_ShareDenyWrite)
      else
        // append to the end later
        Write_File(tofile, s, Data.asLargeInt['at'], rtc_ShareDenyWrite);
