...
public
 ...
 // class function PrepareComprRect(var Rect : TRect);
...
begin
  ...
  WebPPictureImportRGBA := GetProcAddress(DLL, PAnsiChar('WebPPictureImportRGBX'));
...
begin
  ...
  begin
    ...
    custom_ptr := @MemWr;
   // argb := PCardinal(RGB);
  //  argb_stride := IStride shr 3; // in pixels
   // memory_argb_ := RGB;
  end;
